...
- (void)testRetrieveFastTrack {
    ...
    NSEntityDescription *widgetEntity = [NSEntityDescription entityForName:@"Widget" inManagedObjectContext:moc];
    FOSRetrieveCMOOperation *retrieveOp =
        [FOSRetrieveCMOOperation retrieveCMOForEntity:widgetEntity
                                               withId:testWidgetId];
